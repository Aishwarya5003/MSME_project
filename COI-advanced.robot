...
${endpoint_url}=    /cv/v1/coi_advanced
${file_path}=   C:\\Users\\Aishwarya\\PycharmProjects\\APIAutomation\\data\\COI-advancedData.csv
...
${json_schema_file}=    C:\\Users\\Aishwarya\\PycharmProjects\\APIAutomation\\Json_schema\\COI services\\Json_schema COI advanced.json
